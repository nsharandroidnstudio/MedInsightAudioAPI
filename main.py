...
async def upload_voice_data(file: UploadFile = Form(None), user_key: str = Form(None), doctor_id: str = Form(None),
                            patient_id: str = Form(None), topic: str = Form(None)):
    try:
...
async def get_patient_conversations(user_key: str = Form(None), doctor_id: str = Form(None),
...
async def get_id_conversations(user_key: str = Form(None), doctor_id: str = Form(None),
