...
class MongoDBHandler:
    ...
    def create_user_document(self, user_key, doctor_id, patient_id, topic, conversation_id, transcription, chat_analysis):
        return {
            "user_key": user_key,
            "doctor_id":doctor_id,
    ...
    def insert_user_data(self, MedicalRecord , collection_name="patient_conversation"):
        try:
            user_document = self.create_user_document(MedicalRecord.user_key, MedicalRecord.doctor_id, MedicalRecord.patient_id, MedicalRecord.topic, MedicalRecord.conversation_id, MedicalRecord.transcription, MedicalRecord.chat_analysis)
            collection = self.db[collection_name]
